...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to users
	...
	register: function(id, client) {
		// register new users to receive events
	...
	Client: function(elem) {
		// constructor for new simple upload users
		this.handlers = {};
		...
		// register users with singleton to receive flash events
